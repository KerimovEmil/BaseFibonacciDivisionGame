...
# Question for Emil: Does self.array[y][x] have to contain a Rect Object?
# Ideally drawing is outsourced to "Draw Grid" class
class Grid:
    ...
    def populate_initial_state_of_last_row(self):
        end_x = START_X + self.width * BLOCK_SIZE
    ...
    def populate_problem(self, grid):
       ...
       end_x = START_X + grid.width * BLOCK_SIZE
       end_y = START_Y + grid.height * BLOCK_SIZE
